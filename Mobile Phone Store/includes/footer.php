...
if (isset($_POST['sub'])){
    ...
    $query=mysqli_query($con, "inser into tblsubscriber(Email) value('$email')");
    if ($query){
                ...
                <div class="col-xl-2 col-lg-6 col-sm-6 col-12">
                    <div class="footer__menu">
                        ...
                        <ul class="footer__nav">
                            ...
                            <?php if (strlen($_SESSION['msmuid']==0)){ ?>
                ...
                <div class="col-xl-4 col-lg-12 col-12">
                    <div class="footer__menu">
                        ...
                        <ul class="footer__social-nav">
                            <li class="footer__social-list"><a href="#" class="footer_social-link"><i class="fab fa-facebook-f"></i></a></li>
                ...
                <div class="col-lg-12 col-12">
                    <div class="footer__copyright-text">
                        <p style="color:red; font-size: 20px; text-align: center;">
                            Online Mobile Phone Store @2021
                        </p>
                    </div>
                </div>
            </div>
