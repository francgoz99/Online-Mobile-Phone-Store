...
<html lang="zxx">
<head>
    <title>Online Mobile Phone Store||Shopping Cart</title>
    <!-- Vendor CSS Files -->
                    ...
                    <table>
                        ...
                        if ($num>0){
                            while ($row=mysqli_fetch_array($query)){
                                ?>
                        <tr>
                            <td class="product-thumbnail"><a href="single.php?pid=<?php echo $row['ID'];?>"><img class="img-fluid" src="admin/images/<?php echo $row['Image1'];?>" alt=""></a></td>
                            ...
                            <td class="product-remove"><a href="cart.php?delid=<?php echo $row['ID'];?>" onclick="return confirm('Do you really want to Delete?');"><i class="fa fa-times"></i></a></td>
                        </tr><?php $cnt++; }}?>
