...
<html lang="zxx">
<head>
    <title>Online Mobile Phone Store||Checkout Page</title>
        ...
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-box__single-group">
                                ...
                                <input type="text" name="streetname" placeholder="Street Name" class="form-control" required="true">
            ...
            <div class="col-lg-5">
                <div class="your-order-section">
                    ...
                    <button class="btn btn--block btn--small btn--blue btn--uppercase btn--weight" type="submit" name="placeholder">PLACE ORDER</button>
