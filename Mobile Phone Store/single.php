...
if(isset($_POST['review']))
{
    ...
    $pid=$_GET['pid'];
    $query=mysqli_query($con, "insert into tblreview(ProductID,ReviewTitle,Review,Name) 
value('$pid','$reviewtitle','$review','$name')");
    if ($query) {
                            ...
                            <div class="product-gallery-box m-b-60">
                                <div class="product-image--large overflow-hidden">
                                    <img class="img-fluid" id="img-zoom"
                                         ...
                                         data-zoom-image="admin/images/<?php echo $row['Image1'];?>" alt="">
                                </div>
                                <div class="pos-relative m-t-30">
                                    <div id="gallery-zoom" class="product-image--thumb product-image--thumb-horizontal
overflow-hidden swiper-outside-arrow-hover m-lr-30">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a class="zoom-active" data-image="admin/images/<?php echo $row['Image1'];?>"
                                                   data-zoom-image="admin/images/<?php echo $row['Image1'];?>">
                                                    <img class="img-fluid" src="admin/images/<?php echo $row['Image1'];?>" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a data-image="admin/images/<?php echo $row['Image2'];?>"
                                                   data-zoom-image="admin/images/<?php echo $row['Image2'];?>">
                                                    <img class="img-fluid" src="admin/images/<?php echo $row['Image2'];?>" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a data-image="admin/images/<?php echo $row['Image3'];?>"
                                                   data-zoom-image="admin/images/<?php echo $row['Image3'];?>">
                                    ...
                                    <div class="swiper-buttons">
                                        <!-- Add Arrows -->
                                        <div class="swiper-button-next gallery__nav gallery__nav--next">
                                            <i class="fal fa-chevron-right"></i>
                                        </div>
                                        <div class="swiper-button-prev gallery__nav gallery__nav--prev">
                        ...
                        <div class="col-md-6">
                            <div class="product-details-box">
                                ...
                                <div class="review-box">
                                    <?php
                                    $pid=$_GET['pid'];
                                    $ret2=mysqli_query($con,"select * from tblreview where 
ProductID='$pid' && Status='Review Accept'");
                                    $num1=mysqli_num_rows($ret2);

                                    ?>
                                    <a href="#product-review" class="link--gray
link--icon-left  m-b-5"><i class="fal
fa-comment-dots"></i>Read reviews (<?php echo $num1;?>) </a>
                                    <a href="#modalReview" data-toggle="modal" class="link--gray
link--icon-left m-b-5"><i class="fal fa-edit"></i> Write a review</a>
                                </div>
                                    ...
                                    <div class="product-quantity product-var__item">
                                        <div class="product-quantity-box">
                                            ...
                                            <?php if($_SESSION['msmsuid']==""){?>
                                                <a href="login.php" class="btn btn--box btn--small btn--blue
btn--uppercase btn--weight m-l-20">Add to Cart</a>

                                            <?php } else {?>
                                                <form method="post">
                                                    <input type="hidden" name="pid" value="<?php echo $row['ID'];?>">
                                                    <button type="submit" name="submit" class="btn btn--box btn--small btn--blue btn--uppercase
btn--weight m-l-20">Add to Cart</button>
                                                </form>
                                            <?php }?>
                                        </div>
                                ...
                                <div class="product-links ">
                                    ...
                                    <?php if($_SESSION['msmsuid']==""){?>
                                        <a href="login.php" class="link--gray link--icon-left shop__wishlist-icon m-b-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-content--border">
                                <ul class="tablist tablist--style-black
tablist--style-title tablist--style-gap-70 nav">
                                        ...
                                        <ul class="comment">
                                            ...
                                            <li class="comment__list">
                                                <div class="comment__wrapper">
                                                    ...
                                                    $ret=mysqli_query($con,"select * from tblreview where
 ProductID='$pid' && Status='Review Accept'");
                                                    $cnt=1;
                                                    while ($row=mysqli_fetch_array($ret)) {
                                        ...
                                        <a href="#modalReview" data-toggle="modal" class="btn btn--box btn--small
btn--blue btn--uppercase btn--weight m-t-30">Write a review</a>
