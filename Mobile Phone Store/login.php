...
if (isset($_POST['submit'])){
    ...
    $ret=mysqli_query($con, "select * from tbluser where Email='$email' || MobileNumber='contno'");
    $result=mysqli_fetch_array($ret);
    if ($result>0){
        $msg="This email or Contact Number already associated with another account";
    }
    else{
        $query=mysqli_query($con, "insert into tbluser(FirstName, LastName, MobileNumber, Email, Password) value ('$fname', '$lname', '$email', '$password')");
        if ($query){
...
<head>
    ...
    <title>Online Mobile Phone Store | Login Page</title>
    <!-- Vendor CSS Files -->
                                ...
                                <div class="login-register-wrapper">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active">
                                            <div id="lg1" class="login-form-container">
                                                <div class="login-register-form">
                                                    <form action="#" method="post">
                                                        ...
                                                        <div class="form-box__single-group">
                                                            <input type="text" name="emailcont" required="true" placeholder="Register Email or Contact Number" required="true">
                                                        </div>
                                                        <div class="form-box__single-group">
                                                            <input type="password" placeholder="Password" placeholder="Password" required="true">
                                                        </div>
