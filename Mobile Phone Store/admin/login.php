...
<head>
        <title>Mobile Store Management System|| Login Page</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post">
				 <div class="control-group normal_text"> <h3>Mobile Store</strong> <strong style="color: orange">Management System</strong></h3></div>
