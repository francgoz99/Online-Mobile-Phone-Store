...
<head>
    ...
    <script>
        ...
        function popUpWindow(URLStr, left, top, width, height)
        {
            ...
            popUpWin=open(URLStr, 'popUpWin', 'toolbar=no,location=no,direction=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+600+',height='+600+',left='+left+',top='+top',screenX='+left+',screenY='+top+'');
        }
    </script>
</head>
<body>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-content">
                    <h5 class="section-content__title">Your Order Details</h5>
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            ...
                            $query=mysqli_query($con, "select * from tbladdresses where UserId='$userid'");
                            $cnt=1;
                            while ($row=mysqli_fetch_array($query)){
                                ?>
                        <tr>
                            <td><?php echo $cnt;?></td>
                            <td><p><b>Order Date :</b><?php echo ['OrderTime']?></p></td>
